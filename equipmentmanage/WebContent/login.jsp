...
input:focus {
	box-shdow: inset 0 -5px 45px rgba(100, 100, 100, 0.4), 0 1px 1px
		rgba(255, 255, 255, 0.2);
}
</style>
<script
...
<body>
	<img src="images/timg.jpg" style="float:left; margin-left: 23%;margin-top: 10%"/>
	<div class="login">
		<h1>User Login</h1>
		<form method="post" action="LoginServlet">
			...
			<div class="span1">
				<label style="color: white">验证码：</label>
				 <input class="text"
					type="text" name="validateCode"> <span> 
					<img id="validateCode" src="ValidateCodeServlet" onclick="changeValidateCode()" title="点击换一换"> 
